...
All topics will be approached from a highly practical perspective through a diverse instructional format that includes lectures, hands-on sessions, research paper discussions, and case studies. Course requirements also include in-class quizzes, four programming assignments, and three exams.
...
- Time: Mon/Wed 3:30 - 4:50 PM
- Location: NCS 120
- Instructor: Ting Wang (twang@cs.stonybrook.edu)
- TA: TBA 
- Office hours: Mon 1:00 - 2:00 PM or by appointment, NCS 154
- Communication: [Piazza](https://piazza.com/stonybrook/fall2026/cse509)

#### Tentative Schedule:

The tentative schedule and reading materials can be found [here](https://docs.google.com/spreadsheets/d/1nH2kHiaAwqlPhxkLwSpZKUsM6iNR1aV08IjHeOMPNvE/edit?usp=sharings)
...
- Programming Assignments 35% (10%, 10%, 10%, 5%)
- Exams (20%, 20%, 20%)
- Class Participation 5% (Quizzes and Discussion)
