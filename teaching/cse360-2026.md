...
All topics will be approached from a highly practical perspective through a diverse instructional format that includes lectures, hands-on sessions, research paper discussions, and case studies. Course requirements also include a number of quizzes, three assignments, and three exams.
...
- Homework Assignments 30% (10%, 10%, 10%)
- Exam (20%, 20%, 20%)
- Class Participation 10% (Quizzes and Paper Discussion)
