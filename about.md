...
I am Associate Professor of Information Sciences and Technology at Penn State and a part-time research scientist at Meta. I conduct research at the interface of machine learning, privacy, and security. I direct the [Algorithmic Learning, Privacy, and Security]({{ site.baseurl }}/alps) (ALPS) Lab. The overarching goal of my research is to maximize the practical impact of artificial intelligence (AI) by bridging technological advances and real-world applications. To this end, my recent work focuses on improving AI technologies along three major thrusts:
